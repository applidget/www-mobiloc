...
throw new Error(message);}catch(x) {}}};}module.exports = warning;},{"114":114}]},{},[1])(1);});var DeviceType=React.createClass({displayName:"DeviceType",render:function render(){return React.createElement("tr",null,React.createElement("td",null,"iPad 2"),React.createElement("td",null,"400"),React.createElement("td",null,"2"),React.createElement("td",null,"800"));}});var Estimate=React.createClass({displayName:"Estimate",render:function render(){return React.createElement("div",{className:"table-responsive"},React.createElement("table",{className:"table"},React.createElement("thead",null,React.createElement("tr",null,React.createElement("th",null,"Articles"),React.createElement("th",null,"P.U"),React.createElement("th",null,"Q"),React.createElement("th",null,"Total"))),React.createElement("tbody",null,React.createElement(DeviceType,null))));}});React.render(React.createElement(Estimate,null),document.getElementById('estimate'));
