...
throw new Error(message);}catch(x) {}}};}module.exports = warning;},{"114":114}]},{},[1])(1);});var Amandine=React.createClass({displayName:"Amandine",render:function render(){return React.createElement("div",null,React.createElement("h2",null," My name is "),React.createElement("span",null,"Amandine"));}});var Estimate=React.createClass({displayName:"Estimate",render:function render(){return React.createElement("div",null,React.createElement("h1",null," This is an estimate Form "),React.createElement(Amandine,null));}});React.render(React.createElement(Estimate,null),document.getElementById('estimate'));
