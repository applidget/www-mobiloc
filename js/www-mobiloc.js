...
throw new Error(message);}catch(x) {}}};}module.exports = warning;},{"114":114}]},{},[1])(1);});var DeviceType=React.createClass({displayName:"DeviceType",render:function render(){return React.createElement("tr",null,React.createElement("td",null,"iPad 2"),React.createElement("td",null,"400"),React.createElement("td",null,"2"),React.createElement("td",null,"800"));}});var Product=React.createClass({displayName:"Product",toggleLiked:function toggleLiked(){this.setState({ // liked: !this.state.liked
});},render:function render(){return React.createElement("div",{className:'product'},React.createElement("h2",null,"  ",this.props.product.name," "),React.createElement("span",null," ",this.props.product.description," "));}});var ProductsList=React.createClass({displayName:"ProductsList",getInitialState:function getInitialState(){return {products:[]};},componentDidMount:function componentDidMount(){var that=this;jQuery(document).ready(function($){$.ajax({url:"http://applidget.github.io/www-mobiloc/_data/products.yml"}).done(function(data){that.setState({products:jsyaml.load(data)});});});},render:function render(){var products=this.state.products.map(function(product){return React.createElement(Product,{key:product.name,product:product});});return React.createElement("div",{className:'product-gallery'},products);}});React.render(React.createElement(ProductsList,null),document.getElementById('Container'));
//# sourceMappingURL=www-mobiloc.js.map
